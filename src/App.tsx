...
export const App: React.FC = () => {
    ...
    return (<div className="h-screen w-screen flex flex-col p-2.5 gap-2 bg-[var(--app-background)] text-[var(--text-primary)] overflow-hidden select-none font-mono">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-12 gap-2">
        ...
        <div className="col-span-5 h-full min-h-0 flex flex-col gap-2">
          ...
          <div className="h-[32%] min-h-[120px]">
          ...
          <div className="flex-1 min-h-0 flex flex-col gap-1.5">
            ...
            <div className="flex items-center justify-between px-1 shrink-0 text-[11px]">
              <div className="flex items-center gap-1 bg-[#070a12] p-0.5 rounded border border-[#1a2336]">
                <button onClick={() => setRightPanelTab('chat')} className={`px-2.5 py-0.5 rounded flex items-center gap-1.5 font-bold transition-colors ${rightPanelTab === 'chat'
